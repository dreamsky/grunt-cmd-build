exports.init = function(grunt) {
  ...
  exports.jsParser = function(fileObj, options) {
    ...
    // lihongbo change
    // resolve the dep collecting bug
    var depDic = {};
    deps.map(function(dep) {
      var newDep = iduri.parseAlias(options, dep);
      depDic[newDep] = true;
      return newDep;
    });
    deps = [];
  ...
  function parseDependencies(fpath, options) {
    ...
    function relativeDependencies(fpath, options, basefile) {
      ...
      // lihongbo changed
      // ignore some non-standard module file
      if(!parsed)
        return [];
      ...
      parsed.dependencies.map(function(id) {
        ...
        if (id.charAt(0) === '.') {
          ...
          for (var i = 0; i < mdeps.length; i++) {
            var dp = mdeps[i];
            mdeps = mdeps.concat(moduleDependencies(dp, options));
          }
          // console.log(id +','+ mdeps.join(','));
          moduleDeps[id] = mdeps;
